...
function screenLogin() {
  return `<div class="screen no-nav auth-screen has-auth-bg">${authBgHTML()}
    <div class="auth-header">
      ...
      <br><br>
      <img src="icons/icon-192.png" class="logo-img logo-img-sm" style="margin-bottom:16px" alt="ArenaFlow">
...
function screenSASettings() {
  return `<div class="screen">
    ...
    <div style="padding:24px 20px;text-align:center">
      <img src="icons/icon-192.png" class="logo-img logo-img-sm" style="margin:0 auto 12px;display:block" alt="ArenaFlow">
